  ...
  return (
    <div className="space-y-6">
      ...
      <div className="fintech-card rounded-3xl p-6 sm:p-8 border border-slate-200/80 dark:border-white/10 space-y-6 shadow-sm">
        ...
        {/* Business Sector Picker (6 Clean Visual Cards) */}
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-2.5">
            {[
              ...
              { id: 'poultry', label: 'Poultry Unit', icon: '🐔' },
              { id: 'retail', label: 'Kirana Store', icon: '🛍️' },
              { id: 'textiles', label: 'Textiles', icon: '🧵' },
              { id: 'agro', label: 'Grain Mill', icon: '🌾' },
              { id: 'tech', label: 'Tech & Solar', icon: '🔧' },
            ].map((item) => (
              <button
                key={item.id}
                type="button"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
          ...
          <div className="p-4 rounded-2xl bg-amber-500/5 dark:bg-amber-950/15 border border-amber-500/20 space-y-2">
            ...
            <div className="pt-1 text-[11px] text-amber-700 dark:text-amber-300/80">
              💡 Maintaining your 10% margin upfront ensures smooth bank loan processing.
            </div>
          </div>
        </div>
