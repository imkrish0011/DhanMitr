  ...
  return (
    <div className="bg-transparent mt-6">
      ...
      {renewalItems.length === 0 ? (
        <div className="bg-white dark:bg-[#0F172A] border border-slate-200/80 dark:border-slate-800 rounded-2xl p-6 text-center shadow-2xs">
          <p className="text-xs font-semibold text-slate-700 dark:text-slate-300">No active renewals or policy alerts</p>
