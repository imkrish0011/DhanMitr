...
export const QuickActionsSidebar: React.FC = () => {
  ...
  return (
    <aside className="w-72 shrink-0 bg-[#0B101D] border-l border-slate-800/60 p-5 flex flex-col justify-between hidden lg:flex select-none transition-colors duration-300">
      <div className="space-y-6">
        ...
        <div>
          <div className="flex items-center justify-between mb-3">
            ...
            {!isAuthenticated && (
              <span className="text-[11px] text-amber-400 font-bold flex items-center gap-1.5 neumorph-chip px-2 py-0.5 rounded-md">
        ...
        <div>
          ...
          {!isAuthenticated ? (
            <div
              ...
              className="p-4 neumorph-inset rounded-2xl text-center space-y-2.5 cursor-pointer border border-slate-800/50 transition-colors"
            >
              ...
              <div>
                <p className="text-xs font-bold text-slate-200">History Disabled</p>
            ...
            <div className="p-4 neumorph-inset rounded-2xl text-center border border-slate-800/50">
              <p className="text-xs font-bold text-slate-200">Current session active</p>
