...
export const ChatAssistant: React.FC<ChatAssistantProps> = ({
  ...
  return (
    <div className="flex-1 flex h-[calc(100vh-2rem)] bg-[#F8FAFC] dark:bg-[#090D16] rounded-3xl overflow-hidden border border-slate-200/80 dark:border-slate-800 shadow-xs transition-colors duration-200">
      {/* Main Chat Feed */}
      <div className="flex-1 flex flex-col justify-between h-full bg-white dark:bg-[#0F172A]">
        {/* Chat Top Header */}
        <div className="px-6 py-4 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-emerald-50 dark:bg-emerald-950/70 border border-emerald-200 dark:border-emerald-800 flex items-center justify-center">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-xl text-xs font-semibold transition-all"
            >
              <MicIcon className="w-3.5 h-3.5 text-emerald-600 dark:text-emerald-400" />
        ...
        <div className="p-4 sm:p-6 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/40">
          ...
          >
            ...
            <button
              ...
              className="p-2.5 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-40 text-white rounded-xl shadow-xs transition-all active:scale-95"
            >
