      ...
      <div className="p-6 sm:p-10 flex flex-col justify-center bg-white">
        <div className="max-w-sm w-full mx-auto space-y-5">
          ...
          <button
            ...
            className="w-full h-12 px-4 rounded-xl bg-slate-50 hover:bg-slate-100 border border-slate-200 text-slate-800 text-sm font-semibold flex items-center justify-center gap-3 transition-all shadow-2xs active:scale-[0.98] touch-manipulation"
          >
            {/* Google Multi-color SVG with explicit width/height */}
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
              className="w-5 h-5 flex-shrink-0 inline-block"
          ...
          <div className="relative flex items-center justify-center my-1">
            ...
            <span className="bg-white px-3 text-[11px] font-bold text-slate-400 uppercase tracking-wider">or</span>
          </div>
